...
🎮 **Método 3: Steam (opcional)**

Disponível na [loja da Steam](https://store.steampowered.com/app/5010920/OpenSpeedy). Esta é uma forma opcional de instalação.
...
OpenSpeedy é licenciado sob a licença [GPL v3](LICENSE).
